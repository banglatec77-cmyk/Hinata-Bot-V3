        ...
        if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
            ...
            const getBotResponse = async (text, attachments) => {
                ...
                const randomMessage = [
                                ...
                                "naw amr boss k message daw 01umahhhh🤭",
                                ...
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, Xinato , Xinato ও তো করতে পারো😑?",
                                ...
                                "মন সুন্দর বানাও মুখের জন্য তো 'Snapchat' আছেই! 🌚"  
                                  ...
                                  " ইসকা
কারণ দুলাভাই নরেন্দ্র মোদী👴🏽"
                                 " মনডা চায় মাথা টা বেইচা দেই 🦥💨"
                                 "Xinato ডার্লিং এর জন্য একটা বউ লাগবে 😶👀"
                                 "তাজু মারু গু খায়"
                                 "ছ্যাপ খাওয়াই দিব🤢"
                                 "বাবু আমি মা হতে চলেছি 🥲"
      ‌                      " ঘুমটা দিয়ে বসে আছি তুমি আসলে বাসর শুরু হবে লাল বেনারসী শাড়ি আর মুখে মিষ্টি হাসি 🤭"

"মেয়ে হলে Xinato বেবিকে বিয়ে করো আমার সতিন লাগবে"

"এক কাপ চা বানাই স্বামীর 🐸🐣 জন্য পরে রিপ্লাই দিব 😶 "

"বন্ধু তুমি একা হলে আমায় দিও ডাক তোমার সাথে গল্প করব আমি সারারাত 💋"

"আপনার নামাজের কথা মনে আছে তো"

"বিপদে পড়লে কাউকে বলার থেকে আল্লাহকে বলুন মানুষকে বললে সান্তনা ছাড়া কিছু দিতে পারে না কিন্তু আল্লাহকে বললে সাথে সাথে সমস্যার সমাধান করে দিবেন ইনশাআল্লাহ✨"

"“মুসলিম সে, যার জিহ্বা ও হাত থেকে অন্য মুসলিম নিরাপদ।"
